...
as
$$
SELECT pg_catalog.regexp_match($1::pg_catalog.text, $2::pg_catalog.text,
                               CASE WHEN pg_catalog.strpos($3, 'c') = 0 THEN $3 || 'i' ELSE $3 END);
$$;
...
SELECT pg_catalog.regexp_replace($1::pg_catalog.text, $2::pg_catalog.text, $3,
                                 CASE WHEN pg_catalog.strpos($4, 'c') = 0 THEN $4 || 'i' ELSE $4 END);
$$;
...
create or replace function strpos(citext, citext) returns integer
  immutable
  strict
  parallel safe
  language sql
...
create or replace function split_part(citext, citext, integer) returns text
  immutable
  strict
  parallel safe
  language sql
...
create or replace function citext_pattern_lt(citext, citext)
  immutable
  strict
  parallel safe
  language c
...
create or replace function citext_pattern_le(citext, citext)
  immutable
  strict
  parallel safe
  language c
...
create or replace function citext_pattern_gt(citext, citext)
  immutable
  strict
  parallel safe
  language c
...
create or replace function citext_pattern_ge(citext, citext)
  immutable
  strict
  parallel safe
  language c
...
create or replace function citext_pattern_cmp(citext, citext)
  immutable
  strict
  parallel safe
  language c
...
create operator ~>~ (procedure = citext_pattern_gt, leftarg = citext, rightarg = citext);

alter operator ~>~(citext, citext) owner to postgres;

create operator ~>=~ (procedure = citext_pattern_ge, leftarg = citext, rightarg = citext);

alter operator ~>=~(citext, citext) owner to postgres;

create operator ~<~ (procedure = citext_pattern_lt, leftarg = citext, rightarg = citext);

alter operator ~<~(citext, citext) owner to postgres;

create operator ~<=~ (procedure = citext_pattern_le, leftarg = citext, rightarg = citext);
